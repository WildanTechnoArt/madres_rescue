...
public class MapVolunteerActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locations = FirebaseDatabase.getInstance().getReference().child("VolunteerCircle");
        ...
        if (!TextUtils.isEmpty(userNomor)) {
        ...
        user_location.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    VictimData victimData = postSnapshot.getValue(VictimData.class);

                    LatLng friendLocation = new LatLng(Double.parseDouble(victimData.getLat()),
                            Double.parseDouble(victimData.getLng()));
                    ...
                    friend.setLatitude(Double.parseDouble(victimData.getLat()));
                    friend.setLongitude(Double.parseDouble(victimData.getLng()));

                    mMap.clear();

                    if(!userStatus.equals("korban")){
                        bitmapDescriptorFactory = BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN);
                        userTitle = victimData.getNamaUser() +" (Relawan)";
                    }else {
                        bitmapDescriptorFactory = BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED);
                        userTitle = victimData.getNamaUser() +" (Korban)";
                    }


                    // Menambahkan Friend Marker ke MAP
    ...
    private void initMap() {
        ...
        supportMapFragment.getMapAsync(MapVolunteerActivity.this);
    }
